...
export const countries: Countries[] = [
    ...
    { name: "Bouvet Island (Bouvetoya)", code: "BV", dial_code: "+47" },
    { name: "Brazil", code: "BR", dial_code: "+56" },
    {
    ...
    { name: "Comoros the", code: "KM", dial_code: "+269" },
    { name: "Congo", code: "CD", dial_code: "+243" },
    { name: "Congo the", code: "CG", dial_code: "+242" },
    ...
    { name: "Fiji the Fiji Islands", code: "FJ", dial_code: "+679" },
    { name: "Finland", code: "FI", dial_code: "+358" },
    { name: "France, French Republic", code: "FR", dial_code: "+33" },
    ...
    { name: "Korea", code: "KP", dial_code: "+850" },
    { name: "Korea", code: "KR", dial_code: "+82" },
    { name: "Kuwait", code: "KW", dial_code: "+965" },
    { name: "Kyrgyz Republic", code: "KG", dial_code: "+996" },
    { name: "Lao", code: "LA", dial_code: "+856" },
    ...
    { name: "Netherlands the", code: "NL", dial_code: "+31" },
    ...
    { name: "Portugal, Portuguese Republic", code: "PT", dial_code: "+351" },
    ...
    { name: "Slovakia (Slovak Republic)", code: "SK", dial_code: "+421" },
    { name: "Slovenia", code: "SI", dial_code: "+386" },
    { name: "Solomon Islands", code: "SB", dial_code: "+677" },
    { name: "Somalia, Somali Republic", code: "SO", dial_code: "+252" },
    ...
    { name: "Svalbard & Jan Mayen Islands", code: "SJ", dial_code: "+47" },
    { name: "Swaziland", code: "SZ", dial_code: "+268" },
    { name: "Sweden", code: "SE", dial_code: "+46" },
    { name: "Switzerland, Swiss Confederation", code: "CH", dial_code: "+41" },
    ...
    { name: "Uruguay, Eastern Republic of", code: "UY", dial_code: "+598" },
